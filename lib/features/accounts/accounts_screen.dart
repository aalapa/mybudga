...
void _showAccountDetail(BuildContext context, WidgetRef ref, Account account) {
  showModalBottomSheet(
    ...
    useSafeArea: true,
    builder: (_) => _AccountDetailSheet(account: account, ref: ref),
  );
}
...
class _AccountDetailSheet extends StatelessWidget {
  final Account account;
  final WidgetRef ref;
  const _AccountDetailSheet({required this.account, required this.ref});
          ...
          children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(fmt.format(account.balance),
                        style: GoogleFonts.plusJakartaSans(
                            fontSize: 28, fontWeight: FontWeight.w800, color: balColor)),
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: FilledButton.tonal(
                    onPressed: () => _showReconcileSheet(context, account, ref),
