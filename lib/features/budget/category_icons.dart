...
final _kKeywordMap = <(List<String>, IconData)>[
  ...
  (['sport', 'cricket', 'football', 'soccer', 'tennis', 'golf', 'badminton', 'basketball', 'athletic'], Symbols.sports),
...
const _kAllSymbols = <IconData>[
  ...
  Symbols.sports_basketball,    Symbols.theater_comedy,     Symbols.beach_access,
  Symbols.hiking,               Symbols.casino,             Symbols.nightlife,
  Symbols.shopping_bag,         Symbols.shopping_cart,      Symbols.watch,
  Symbols.face,                 Symbols.content_cut,        Symbols.local_laundry_service,
  Symbols.child_care,           Symbols.pets,               Symbols.account_balance,
